      ...
      <div className="grid gap-3">
        {pains.map((pain, i) => (
          <ScrollReveal key={i} delay={i * 0.05}>
            <div className="flex items-start gap-4 bg-background rounded-xl p-5 border border-border/40">
              <span className="text-accent font-semibold mt-0.5 shrink-0" aria-hidden="true">✕</span>
