    ...
    <div className="container max-w-3xl mx-auto px-6">
      <ScrollReveal>
        ...
        <div className="text-lg md:text-xl text-muted-foreground leading-relaxed space-y-4">
          ...
          <p>
            The problem: you don't have a <strong className="text-foreground">roadmap</strong>. Every
          ...
          <p>
            ...
            <strong className="text-foreground">$2,600–$4,000</strong>—and most people still don't practice
            on their own.
          </p>
          <p className="text-foreground font-medium">Guitar OS solves this differently.</p>
          <p>
