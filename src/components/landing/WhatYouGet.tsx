...
const modules = [
  {
    ...
    desc: "A structured 30-minute daily plan covering what to practice, in what order, and for how long—so every session starts with direction.",
  },
  {
    num: "02",
    title: "Fundamentals, Built In",
  ...
  },
  {
    ...
    desc: "Beginner 1–3, Intermediate 1–3, plus an Advanced framework. Each level builds deliberately on the last.",
  },
  {
    num: "06",
      ...
      <div className="grid md:grid-cols-2 gap-x-14 gap-y-12">
        {modules.map((m, i) => (
          <ScrollReveal key={m.num} delay={i * 0.06}>
            <div>
              <span className="text-primary font-semibold text-xs tracking-[0.15em]">
                {m.num}
              </span>
              <h3 className="text-xl font-semibold tracking-tight mt-2 mb-3">
                {m.title}
              </h3>
